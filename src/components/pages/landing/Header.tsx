...
export function Header() {
  return (
    <>
      ...
      <div className="sticky top-0 z-50 w-full 2xl:pt-8 pointer-events-none transition-all duration-500">
        <header className="pointer-events-auto mx-auto w-full 2xl:max-w-[1700px] border-b 2xl:border border-border/40 bg-background/95 2xl:bg-background/60 backdrop-blur-xl supports-[backdrop-filter]:bg-background/60 2xl:rounded-[2rem] 2xl:shadow-2xl transition-all duration-500">
          <div className="w-full max-w-7xl 2xl:max-w-none mx-auto px-4 sm:px-6 lg:px-8 2xl:px-12 flex h-16 2xl:h-20 items-center justify-between">
            ...
            <div className="flex items-center justify-end space-x-2 sm:space-x-4">
              ...
              <a href="/auth/signup">
                <Button
                  size="sm"
                  className="rounded-full shadow-md shadow-primary/20 sm:px-6 sm:h-9 h-8 text-xs sm:text-sm"
                >
                  Sign up
                </Button>
              </a>
      ...
      <div className="hidden md:flex lg:hidden fixed left-4 top-1/2 -translate-y-1/2 z-50 animate-in slide-in-from-left-8 duration-500">
        <div className="bg-background/80 backdrop-blur-xl border border-border/50 shadow-2xl shadow-primary/10 rounded-full flex flex-col items-center justify-center gap-6 px-3 py-6">
          <a
            href="/showcase"
            className="text-muted-foreground hover:text-primary transition-colors flex flex-col items-center gap-1"
            title="Showcase"
          >

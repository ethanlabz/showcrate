    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex flex-1 items-center justify-center gap-2 rounded-lg border border-border bg-secondary/50 px-4 py-2.5 text-sm font-medium text-muted-foreground cursor-not-allowed opacity-60"
        >
